...
> **📖 延伸专题**
>
> 本周讲义聚焦 Agent 的**推理与运行时**视角（ReAct、Tool Use、记忆、Context Rot），有意省略了"如何训练出更好的 Agent"这一训练侧问题。如果你想了解 Agent SFT 数据合成、多轮 GRPO、奖励设计与环境工程，请参阅：
>
> - [AgenticRL 与 Agent 训练](专题学习/AgenticRL与Agent训练.md) — Agent 能力的训练侧完整体系
